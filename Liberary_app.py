class Liberary():
    ...
    def LendBook(self, book , name):
        if book not in self.BookList:
            print(f"We dont have this book in the Library , we have these Books Right Now!{self.BookList}")
            exit()
...
if __name__ == '__main__':
    ...
    while(True):
        ...
        if user_choice == 1:
            ...
            AddBook_input = input("Enter The Name of Book , you want Add in Liberary : \n")
            Pratik.AddBook(AddBook_input)

        elif user_choice == 3:
            lendInputBook = input("Enter the Name of Book , you want to Lend : \n")
            lendInputUser = input("Enter Your Name : \n")
            Pratik.LendBook(lendInputBook , lendInputUser)

        elif user_choice == 4:
            returnBookInput = input("Enter the name of Book , you want to retur : \n")
            Pratik.returnBook(returnBookInput)

        elif user_choice == 5:
            TakeBookInput = input("Enter the name of Book , you want to check : \n")
